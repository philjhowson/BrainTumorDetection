...
def train_resnet(version = 1):
    ...
    print(f"Model preparation complete! Training ResNet50 version {version} now.")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description = "Train the ResNet50 model.")
    parser.add_argument("--version", type = int, help = "version number, defaults to 1, expects and int.")
    args = parser.parse_args()
    train_resnet(args.version)
