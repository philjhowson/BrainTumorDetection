...
plt.savefig(f'images/resnet_history_v{version}.png', bbox_inches = 'tight')
...
with open("metrics/resnet_50_classification_report.pkl", "wb") as f:
    pickle.dump(report_dict, f)

scores = {'ROC-AUC' : test_roc_score,
          'F1 Score' : test_f1_score}

with open("metrics/resnet_50_scores.pkl", "wb") as f:
...
plt.savefig(f'images/custom_resnet50_grad_cam_v{version}.png', bbox_inches = 'tight')
